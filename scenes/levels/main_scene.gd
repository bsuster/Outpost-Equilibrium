...
func _show_game_over_screen() -> void:
	...
	var game_over_art = [
		...
		"",
		"# PWR: [color=" + power_color + "]" + str(SystemManager.power) + "%[/color]",
		"# OXY: [color=" + oxygen_color + "]" + str(SystemManager.oxygen) + "%[/color]",
		"# FOD: [color=" + food_color + "]" + str(SystemManager.food) + "%[/color]",
		"",
